...
| Downloader | `yt-dlp` (yt, in-container) + sibling [aria2](../aria2) service for bt (one-shot `aria2c` per magnet, 1440 min / ratio 1.0 seed limits; peer traffic exits via PIA gluetun so tracker / peer / DHT IPs never leak transcribe's origin) |
